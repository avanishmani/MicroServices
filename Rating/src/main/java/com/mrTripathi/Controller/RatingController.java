...
public class RatingController {
	...
	public ResponseEntity<List<Rating>> getAllRatingByUser(@PathVariable Integer UID) {
		return new ResponseEntity<List<Rating>>(rs.getRatingByUserID(UID), HttpStatus.OK);
	}

	@GetMapping("/ratings/hotel/{HID}")
	public ResponseEntity<List<Rating>> getAllRatingForHotel(@PathVariable Integer HID) {
